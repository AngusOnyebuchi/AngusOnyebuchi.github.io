  ...
  return (
    <div className='w-full h-[1895px] static t-[2740px]'>
      ...
      <div className='ml-[700px] mt-[15px]'>
          <div style={{backgroundImage: `url(${MoveImg})`}} className='absolute w-[484px] h-[650px] rounded-md bg-cover bg-center'></div>
      </div>
      ...
      <div className='ml-[700px] mt-[730px]'>
          <div style={{backgroundImage: `url(${WomanImg})`}} className='bg-red-700 absolute w-[484px] h-[650px] rounded-md bg-cover bg-center'></div>
      </div>
