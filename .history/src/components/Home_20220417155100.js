...
export default function Home() {
    return (
        <div className="w-full h-screen p-4 bg-blue-900 text-gray-200">
            ...
            <h3 className="text-3xl md:text-5xl font-bold uppercase pt-8 text-center">I am a Frontend Developer</h3>
            <p className="font-bold text-center justify-center text-lg md:text-2xl max-w-[1000px] mx-12 mt-4">I strive to be the best, obtain hands-on-deck skills, 
