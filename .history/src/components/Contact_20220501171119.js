    ...
    <div className='w-full'>
      ...
      <div className='flex justify-between items-center px-16 py-16'>
        ...
        <div>
          ...
          <h1 className='font-bold py-4 text-lg'>Arctic Travels</h1>
          ...
          <div className='flex items-center justify-between py-12'>
            ...
            <FaInstagram size={30} className="text-blue-700 cursor-pointer"/>
            <FaTwitter size={30} className="text-blue-700 cursor-pointer"/>
          </div>
        </div>
