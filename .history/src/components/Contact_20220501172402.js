    ...
    <div className='w-full'>
      ...
      <div className='flex justify-between items-center px-16 py-16'>
        ...
        <div className='flex items-left justify-between gap-16'>
          <div>
            <h2 className='uppercase font-semibold text-blue-700 pb-6'>Company</h2>
            <ul>
          ...
          <div>
            <h2 className='uppercase font-semibold text-blue-700 pb-6'>Contact</h2>
            <ul>
          ...
          <div>
            <h2 className='uppercase font-semibold text-blue-700 pb-6'>more</h2>
            <ul>
