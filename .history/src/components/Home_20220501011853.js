  ...
  return (
        <div style={{backgroundImage: `url(${HomeImg})`}} className="w-full h-screen text-white">
            ...
            <div className='px-12 py-20'>
                <h1 className='capitalize font-bold text-6xl'>plan the perfect winter trip</h1>
                <p className='text-lg'>Easily plan your ideal ski trip from home with the <br/> help of professionals</p>
