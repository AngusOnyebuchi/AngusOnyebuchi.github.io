...
export default function Resorts() {
  return (
    <div className='w-full h-screen'>
      <div className='relative grid grid-cols-3  h-screen text-white'>
        <div style={{backgroundImage: `url(${MoveImg})`}} className="h-screen bg-cover bg-left ">
          <p className='absolute text-4xl font-sans font-semibold rotate-90 top-[80%] right-0'>Mountain Resort</p>
        </div>
        ...
        <p className='text-4xl font-sans font-semibold'>Freezing WinterLate</p>
        </div>
      </div>
    </div>
  )
