...
import {FaLinkedin, FaFacebook, FaWhatsapp, FaTwitter, FaArrowDown, FaInstagram} from "react-icons/fa"
  ...
  return (
    <div className='w-full h-screen bg-[#F8F9FC]'>
      ...
      <div className='text-center pt-20 pb-24'>
        ...
        <h1 className='text-4xl font-bold'>View Regions <span className='text-blue-700'>available</span><FaArrowDown/></h1>
      </div>
    </div>
  )
}
