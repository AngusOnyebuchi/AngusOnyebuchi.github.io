...
export default function NavBar() {
  ...
  return (
        <div className='fixed relative flex items-center mr-8 px-8 md:px-16 py-4 w-full bg-blue-700 text-white'>
                ...
                <div className='hidden md:flex items-center'>
                    ...
                    <div className='ml-[400px]'>
                        <button className='bg-white text-[#3E86F5] font-semi-bold py-2 px-8 rounded-md'>Sign In</button>
                    </div>
                </div>
