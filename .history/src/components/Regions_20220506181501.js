  ...
  return (
    <div className='w-full h-screen bg-[#F8F9FC]'>
      ...
      <div className='text-center pt-20 pb-24'>
        ...
        <p className='pb-16 text-xl'>Would you explore nature paradise in the world, find the <br/> best destination in the world with us.</p>
        <h1 className='text-4xl font-bold'>View Regions <span className=''>available</span></h1>
        <FaArrowDown size={30} className="text-[#3E86F5] ml-[600px] mt-4"/> 
      </div>
    </div>
  )
}
