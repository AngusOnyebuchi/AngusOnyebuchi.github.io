...
export default function Experience() {
    return(
        <div name="experience" className="bg-[#0a192f] w-full p-12 sm:p-40 text-gray-200">
            <h1 className="text-3xl md:text-5xl font-bold uppercase text-center text-gray-200 inline border-b-2 border-pink-300 ml-12 sm:ml-60">research experience</h1>
