...
export default function Relax() {
  return (
    <div className='w-[1440px] h-[1895px] static left-[0px] top-[2740px]'>
      <div className='p-16'>
        <p className='font-bold text-4xl absolute w-[570px] h-[130px] l-[120px] top-[101px]'>The best resorts to chill <br/> and relax</p>
      </div>
