...
export default function Experience() {
    return(
        <div className="bg-[#0a192f] w-full h-screen text-gray-200">
            <h1 className="text-4xl md:text-6xl font-bold uppercase pt-24 text-center text-gray-200 inline border-b-2 border-pink-300 ml-24 sm:ml-64">research experience</h1>
