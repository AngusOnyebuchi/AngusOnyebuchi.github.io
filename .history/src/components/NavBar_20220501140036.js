...
export default function NavBar() {
  ...
  return (
        <div className='fixed flex items-center mr-8 px-8 md:px-16 py-8 text-white'>
                ...
                {/** Menu Bar Icon */}
                <div onClick={toggle} className="sm:hidden z-10 ml-28">
                {nav ? <FaBars/> : <FaTimes/>}
                </div>


                {/** Menu Bar for mobile users */}
                <div className={nav ? 'hidden' : 'absolute top-0 left-0 w-full h-screen bg-inherit flex flex-col justify-center items-center md:hidden'}>
                    <ul className=' text-gray-100 py-24'>
                        <li>About Us</li>
                        <li>Support</li>
                        <li>Language</li>
                    </ul>
