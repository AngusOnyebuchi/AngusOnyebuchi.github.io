...
export default function NavBar() {
    ...
    return(
        <div className="sm:fixed bg-[#0a192f] text-white w-full p-8 flex justify-between items-center border-b-2 border-pink-300">
            <div className="h-[40px] w-[130px] bg-gray-600 flex text items-center border border-rounded-4">
                <h1 className="uppercase text-lg mx-4 font-bold text-[#0a192f]">Angus CV</h1>
            </div>
