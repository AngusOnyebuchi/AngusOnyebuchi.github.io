...
export default function Experience() {
    return(
        <div className="bg-[#0a192f] w-full h-screen text-gray-200">
            <h1 className="text-3xl md:text-5xl font-bold uppercase pt-24 text-center text-gray-200 inline border-b-2 border-pink-300 ml-12 sm:ml-58">research experience</h1>
