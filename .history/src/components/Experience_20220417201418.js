    ...
    return(
        <div className="bg-[#0a192f] w-full h-screen text-gray-200">
            ...
            <div className="grid grid-cols-2 gap-12 mx-16 pt-8 ">
                <h3 className="capitalize text-xl md:text-3xl text-right">Advanced Ceramics Institute, University of Bremen Germany</h3>
                <h4 className="text-lg md:text-3xl ">2019 – 2020</h4>
            </div>
            <div className="grid grid-cols-2 gap-12 mx-16 pt-4">
                <h3 className="capitalize text-xl md:text-3xl text-right">ACE FUELS FUTO, Imo state, Nigeria</h3>
